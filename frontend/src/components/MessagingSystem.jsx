...
const MessagingSystem = ({ user }) => {
  ...
  const contacts = user?.role === 'recruiter' ? [
    { id: 'REQ001', name: 'Harini Krishnan', role: 'requestor', online: true },
    { id: 'REQ002', name: 'Kovarthini', role: 'requestor', online: false }
  ] : [
    { id: 'REC001', name: 'Gokul Kumar', role: 'recruiter', online: true },
